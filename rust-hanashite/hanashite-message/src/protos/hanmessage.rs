...
pub mod han_message {
    ...
    pub enum Msg {
        ...
        #[prost(message, tag="4")]
        Challenge(super::ChallengeCmd),
        #[prost(message, tag="5")]
        ChallengeResponse(super::ChallengeResponse),
        #[prost(message, tag="6")]
        VoiceChannelJoin(super::VoiceChannelJoinCmd),
        #[prost(message, tag="7")]
        VoiceChannelJoinResponse(super::VoiceChannelJoinResponse),
        #[prost(message, tag="8")]
        VoiceChannelJoinEvent(super::VoiceChannelJoinEvent),
        #[prost(message, tag="9")]
        VoiceChannelLeaveEvent(super::VoiceChannelLeaveEvent),
    }
}
///
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VoiceChannelJoinCmd {
    #[prost(string, tag="1")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VoiceChannelJoinEvent {
    #[prost(uint32, tag="1")]
    pub user_id: u32,
    #[prost(string, tag="2")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct VoiceChannelLeaveEvent {
    #[prost(uint32, tag="1")]
    pub user_id: u32,
    #[prost(string, tag="2")]
    pub user_name: ::prost::alloc::string::String,
